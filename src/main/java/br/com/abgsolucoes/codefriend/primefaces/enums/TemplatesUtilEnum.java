...
public enum TemplatesUtilEnum {
    ...
    METODO_BUSCA("buscar"), FILTRO_BUSCA("filtroBusca"), ACTION_SALVAR("salvar"), ACTION_DETALHAR("detalhar"), ACTION_DELETAR("deletar"), ACTION_EXCLUIR("excluir"), SUFFIX_DATA_TABLE("DT"), SUFIXX_FORM("form"), PREFIX_LISTA("lista"), SUFFIX_SELECIONADO("Selecionado"), SUFIX_CRUD_SALVAR("Salvar"), PACKAGE("br.com.abgsolucoes.sigaweb.seguranca.bean"),
